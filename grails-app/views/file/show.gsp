	...
	<body>
		...
		<div id="show-file" class="content scaffold-show" role="main">
			...
			<ol class="property-list file">
				...
				<g:if test="${fileInstance?.date}">
				<li class="fieldcontain">
					<span id="date-label" class="property-label"><g:message code="file.date.label" default="Date" /></span>
					
						<span class="property-value" aria-labelledby="date-label"><g:formatDate date="${fileInstance?.date}" /></span>
				...
				<g:if test="${fileInstance?.type}">
				<li class="fieldcontain">
					<span id="type-label" class="property-label"><g:message code="file.type.label" default="Type" /></span>
					
						<span class="property-value" aria-labelledby="type-label"><g:fieldValue bean="${fileInstance}" field="type"/></span>
					
				</li>
				</g:if>
			
				<g:if test="${fileInstance?.uri}">
				<li class="fieldcontain">
					<span id="uri-label" class="property-label"><g:message code="file.uri.label" default="Uri" /></span>
					
						<span class="property-value" aria-labelledby="uri-label"><g:fieldValue bean="${fileInstance}" field="uri"/></span>
