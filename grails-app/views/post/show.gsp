	...
	<body>
		...
		<div id="show-post" class="content scaffold-show" role="main">
			...
			<ol class="property-list post">
				...
				<g:if test="${postInstance?.image}">
				<li class="fieldcontain">
					<span id="image-label" class="property-label"><g:message code="post.image.label" default="Image" /></span>
					
						<span class="property-value" aria-labelledby="image-label"><g:link controller="file" action="show" id="${postInstance?.image?.id}">${postInstance?.image?.encodeAsHTML()}</g:link></span>
